  ...
  return (
    <>
      <Box p={8} pt={16} display='flex' flexDirection='column' bg="rgb(196 38 38)" minH="100vh" justifyContent='space-between' alignItems='start'>
        <Box>
          <Box display='flex'justifyContent='center' pb={10}><UserPic/></Box>
          <Image></Image>
          <Button colorScheme='red' bg='transparent' gap={2}><IoPersonSharp size='13px'color='white' /><a href='/home'><Heading as='h1' size='sl' py={2}>Inicio</Heading></a></Button>
          ...
          <Button colorScheme='red' bg='transparent' gap={2}><FaComputer size='13px'color='white' /><a href='/prestamos'><Heading as='h1' size='sl' color='white' py={2}>Prestamos</Heading></a></Button>
         </Box>
         <Box>
